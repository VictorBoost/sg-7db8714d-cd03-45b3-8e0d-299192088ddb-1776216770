...
export default function VerifyDomesticHelpers() {
  ...
  return (
    <>
      <SEO 
        title="Verify Domestic Helpers - Admin | BlueTika"
        description="Review and approve Domestic Helper service provider verifications"
      />
      <div className="min-h-screen flex flex-col">
        <main className="flex-grow py-12">
          <div className="container">
            <div className="mb-8">
              <h1 className="text-3xl font-bold mb-2">Domestic Helper Verifications</h1>
