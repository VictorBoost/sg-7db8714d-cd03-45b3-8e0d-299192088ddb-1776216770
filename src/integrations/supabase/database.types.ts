    ...
    Tables: {
      ...
      contracts: {
        Row: {
          ...
          client_id: string
          client_work_accepted_at: string | null
          completed_at: string | null
          created_at: string | null
          escrow_admin_hold: boolean | null
          escrow_auto_notice_sent_at: string | null
          escrow_auto_reject_deadline: string | null
          ...
          status: string | null
          stripe_payment_intent_id: string | null
          stripe_payout_scheduled_for: string | null
          total_amount: number | null
          updated_at: string | null
